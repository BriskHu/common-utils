...
layui.define("layer", function (e) {
            ...
            select: function () {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                    f = u.find("select"), v = function (t, l) {
                        ...
                        var h, p = i(this), m = t.find("." + n), k = m.find("input"), g = t.find("dl"),
                            x = g.children("dd"), b = this.selectedIndex;
                        if (!u) {
                            var C = function () {
                                var e = t.offset().top + t.outerHeight() + 5 - y.scrollTop(), i = g.outerHeight();
                ...
                f.each(function (e, l) {
                    ...
                    var y = "string" == typeof r.attr("lay-search"), p = v ? v.value ? t : v.innerHTML || t : t,
    ...
    var d = function () {
        var e = i(this), a = f.config.verify, s = null, c = "layui-form-danger", o = {}, u = e.parents(r),
            d = u.find("*[lay-verify]"), v = e.parents("form")[0], y = u.find("input,select,textarea"),
            h = e.attr("lay-filter");
        if (layui.each(d, function (e, l) {
            var r = i(this), o = r.attr("lay-verify").split("|"), u = r.attr("lay-verType"), d = r.val();
    ...
    }, f = new u, v = i(document), y = i(window);
